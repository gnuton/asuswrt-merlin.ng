...
#define msleep(i) cfe_usleep(1000*i)
#endif
...
#else
#   define SOTP_DBG(fmt, args...) printf( "SOTP: " fmt, ## args)
#endif /* _CFE_ */
...
#if (INC_BTRM_BUILD==1)
#define SOTP_ERR_PRINT(... ) {btrm_print( _UI32('S','T','P','E')); }
#else
#ifndef _CFE_
#define SOTP_ERR_PRINT(fmt, args...) printk( KERN_ERR "SOTP_drv: " fmt, ## args)
#else
#define SOTP_ERR_PRINT(fmt, args...) printf( "SOTP: " fmt, ## args)
#endif /* _CFE_ */
#endif /* INC_BTRM_BUILD==1 */
...
#else
#define SOTP_PRINT(fmt, args...) printf( fmt, ## args)
#endif /* _CFE_ */
#endif /* INC_BTRM_BUILD==1 */
...
static SotpRowStatus sotpPrepForFusing(void)
{
   ...
   sotp_base_ptr->sotp_chip_cntrl |= (SOTP_CHIP_CTRL_SW_MANU_PROG | SOTP_CHIP_CTRL_SW_NON_AB_DEVICE | \
