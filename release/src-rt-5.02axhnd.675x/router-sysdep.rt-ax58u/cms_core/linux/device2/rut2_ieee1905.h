 ...
 *
 ************************************************************************/
#ifndef __RUT2_IEEE1905_H__
#define __RUT2_IEEE1905_H__
...
/* Start 1905 daemon
 * @return CMSRET_SUCCESS on success otherwise return CMSRET_INTERNAL_ERROR;
 */
CmsRet rutIeee1905_initialize( );

/** 
 *
 * @param obj  (IN)  Device Id
 *                   remoteInterfaceId
 *            (OUT)  all available statistics
 *
 * @return CMSRET_SUCCESS on success otherwise return CMSRET_INTERNAL_ERROR;
 */
...
/**
 *
 * @param obj  (IN)  remoteInterfaceId
 *            (OUT)  all available statistics
 *
 * @return CMSRET_SUCCESS on success otherwise return CMSRET_INTERNAL_ERROR;
 */
...
/** Update 1905 AL configuration
 *
 * @param obj  (IN)  The new settings.
 *
 * @return CMSRET_SUCCESS on success otherwise return CMSRET_INTERNAL_ERROR;
 */
CmsRet rutIeee1905_updateAl(const _Dev2Ieee1905AlObject *obj);

/** Update 1905 Network Topology configuration
 *
 * @param obj  (IN)  The new settings.
 *
 * @return CMSRET_SUCCESS on success otherwise return CMSRET_INTERNAL_ERROR;
...
/** Update 1905 Network Topology Device Friendly Name (Local Device Only)
 *
 * @param obj  (IN)  The new settings.
 *
 * @return CMSRET_SUCCESS on success otherwise return CMSRET_INTERNAL_ERROR;
