...
CmsRet stl_wlBaseCfgObject(_WlBaseCfgObject *obj __attribute__((unused)), const InstanceIdStack *iidStack __attribute__((unused)))
{
   return CMSRET_SUCCESS_OBJECT_UNCHANGED;
}
...
CmsRet stl_wlVirtIntfCfgObject(_WlVirtIntfCfgObject *obj, const InstanceIdStack *iidStack __attribute__((unused)))
{
   UBOOL8 isLinkUp;
