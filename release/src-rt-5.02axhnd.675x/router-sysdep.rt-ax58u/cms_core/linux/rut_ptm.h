 ...
 *
 ************************************************************************/
#ifndef __RUT_PTM_H__
#define __RUT_PTM_H__

/*!\file rut_ptm.h
 * \brief System level interface functions for PTM functionality.
 *
...
/** Set the connection configuration for the ptm interface
 * @param *newObj          (IN) the _WanPtmLinkCfgObject
 *
 * @return CmsRet enum.
 */
CmsRet rutPtm_setConnCfg(const _WanPtmLinkCfgObject *newObj);

/** Create  the ptm interface
 * @param *newObj          (IN) the _WanPtmLinkCfgObject
 *
 * @return CmsRet enum.
 */
 ...
 * @param *currObj          (IN) the _WanPtmLinkCfgObject
 *
 * @return CmsRet enum.
 */
CmsRet rutPtm_deleteInterface(const _WanPtmLinkCfgObject *currObj);

/** Delete the ptm network connection
 * @param *currObj          (IN) the _WanPtmLinkCfgObject
 *
 * @return CmsRet enum.
 */
