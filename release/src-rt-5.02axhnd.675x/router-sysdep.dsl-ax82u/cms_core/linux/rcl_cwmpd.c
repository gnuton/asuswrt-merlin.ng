...
CmsRet rcl_cwmpdCfgObject( _CwmpdCfgObject *newObj,
                const _CwmpdCfgObject *currObj,
                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   if (newObj != NULL && currObj != NULL)
   {
       ...
       * is set.
       */
      rut_updateLogLevel(EID_CWMPD, newObj->loggingLevel);

      rut_updateLogDestination(EID_CWMPD, newObj->loggingDestination);
   }
