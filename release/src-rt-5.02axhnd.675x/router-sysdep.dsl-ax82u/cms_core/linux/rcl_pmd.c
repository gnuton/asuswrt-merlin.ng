...
CmsRet rcl_pmdCfgObject( _PmdCfgObject *newObj,
                const _PmdCfgObject *currObj,
                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   if (newObj != NULL && currObj != NULL)
   {
       ...
       * is set.
       */
      rut_updateLogLevel(EID_PMD, newObj->loggingLevel);

      rut_updateLogDestination(EID_PMD, newObj->loggingDestination);
   }
