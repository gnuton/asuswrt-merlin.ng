...
/** updates the logical volume info(ex;cpacity used/free etc.) for a give partition 
 *
 * @param path (IN) path of directory where partition is mounted.
 * @param ethIntfCfg (OUT) if not null, this will contain a pointer to the
 *                   found logicalVolume object.
 *
 * @return CmsRet
 */
 ...
 * @param password (IN) password for user account.
 * @param homeDir (IN)  path of directory to be used as home directory for this user
 * @return CmsRet
 */
