...
CmsRet rcl_dadCfgObject( _DadCfgObject *newObj,
                const _DadCfgObject *currObj,
                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   if (newObj != NULL && currObj != NULL)
   {
       ...
       * is set.
       */
      rut_updateLogLevel(EID_DAD, newObj->loggingLevel);

      rut_updateLogDestination(EID_DAD, newObj->loggingDestination);
   }
