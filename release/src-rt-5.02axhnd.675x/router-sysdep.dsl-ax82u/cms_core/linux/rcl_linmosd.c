...
CmsRet rcl_linmosdCfgObject( _LinmosdCfgObject *newObj,
                const _LinmosdCfgObject *currObj,
                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   if (newObj != NULL && currObj != NULL)
   {
       ...
       * is set.
       */
      rut_updateLogLevel(EID_LINMOSD, newObj->loggingLevel);

      rut_updateLogDestination(EID_LINMOSD, newObj->loggingDestination);
   }
