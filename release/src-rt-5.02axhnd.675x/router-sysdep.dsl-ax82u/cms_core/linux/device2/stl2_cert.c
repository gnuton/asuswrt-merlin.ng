...
CmsRet stl_dev2SecurityObject(_Dev2SecurityObject *obj __attribute__((unused)),
...
CmsRet stl_dev2SecurityCertificateObject(_Dev2SecurityCertificateObject *obj __attribute__((unused)),
                                         const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* Nothing to implement here yet */
    return CMSRET_SUCCESS_OBJECT_UNCHANGED;
