...
CmsRet stl_speedServiceObject(_SpeedServiceObject *obj __attribute__((unused)), const InstanceIdStack *iidStack __attribute__((unused)))
{
   /* no change is needed since SSK is updating MDM with proper stats from ss */
