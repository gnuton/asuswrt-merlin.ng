...
CmsRet rcl_dmadCfgObject( _DmadCfgObject *newObj,
                const _DmadCfgObject *currObj,
                ...
                CmsRet *errorCode __attribute__((unused)))
{
   ...
   if (newObj != NULL && currObj != NULL)
   {
       ...
       * is set.
       */
      rut_updateLogLevel(EID_DMAD, newObj->loggingLevel);

      rut_updateLogDestination(EID_DMAD, newObj->loggingDestination);
   }
