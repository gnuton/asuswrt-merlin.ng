...
/** Restart sntp with the TimeServerCfg entry in the MDM
 *
 ...
 *
 * @param sntpObj (IN) The new TIME object to check.
 *
 * @return TRUE if all required fields are non-null, otherwise, return FALSE.
 */
UBOOL8 rutTime_isAllRequiredValuesPresent(const _TimeServerCfgObject *sntpObj);
