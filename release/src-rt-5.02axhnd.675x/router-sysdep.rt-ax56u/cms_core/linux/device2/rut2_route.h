...
/** Select an interface which can be used as the system default gateway
 *
 */
...
/** Call this when IPv6 service comes up
 *
 */
CmsRet rutRt_activateIpv6Routing_dev2(const char *ipIntfFullPath);


/** Call this when IPv6 service goes down.
 *
 */
