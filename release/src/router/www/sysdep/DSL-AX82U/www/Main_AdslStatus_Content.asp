...
function display_basic_dsl_information(){
	if(status_isVDSLmode == "VDSL")
	{
		...
		document.getElementById("tr_VDSL_VectoringState").style.display = "";
	}
	else
	{
		...
		document.getElementById("tr_VDSL_VectoringState").style.display = "none";
	}
}
		...
		success: function(){
				...
				if(sync_status_update == "up")
				{
					...
					if(status_isVDSLmode == "VDSL")
					{
						...
						document.getElementById("div_VDSL_VectoringState").innerHTML = log_VDSL_VectoringState;
					}
				...
				else
				{
					...
					document.getElementById("div_VDSL_VectoringState").innerHTML = "";
				}
				...
				document.getElementById("div_TCMDown").innerHTML = log_TCMDown;
				document.getElementById("div_TCMUp").innerHTML = log_TCMUp;
				...
				document.getElementById("div_GINPDown").innerHTML = log_GINPDown;
				document.getElementById("div_GINPUp").innerHTML = log_GINPUp;
				...
				document.getElementById("div_ESUp").innerHTML = log_ESUp;
				document.getElementById("div_SESDown").innerHTML = log_SESDown;
				document.getElementById("div_SESUp").innerHTML = log_SESUp;
				}
				...
				<tr>
					<td bgcolor="#4D595D" height="350px" colspan="3" valign="top">
						...
						<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable_log">
							...
							<tr id="tr_VDSL_VectoringState">
								<th>Vectoring State</th>
								<td colspan="2">
									<div id="div_VDSL_VectoringState"><% nvram_get("dsllog_vectoringstate"); %></div>
								</td>
							</tr>
					...
					<td bgcolor="#4D595D" colspan="3" valign="top">
						<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable_log">
							...
							<tr>
								...
								<td>
									<div id="div_TCMDown"><% nvram_get("dsllog_tcmdown"); %></div>
								</td>
								<td>
									<div id="div_TCMUp"><% nvram_get("dsllog_tcmup"); %></div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<th>G.INP</th>
								<td>
									<div id="div_GINPDown"><% nvram_get("dsllog_ginpdown"); %></div>
								</td>
								<td>
									<div id="div_GINPUp"><% nvram_get("dsllog_ginpup"); %></div>
								</td>
							</tr>
							<tr>
								<th>INP</th>
