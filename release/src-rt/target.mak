...
export DSL-AC68U-NONE := LOGO_LED=y LED_BTN=y ROG=y
export DSL-AC68U := $(filter-out $(DSL-AC68U-NONE),$(RT-AC68U_BASE))
export DSL-AC68U += BUILD_NAME="DSL-AC68U" DSL=y DSL_TCLINUX=y VDSL=y BTN_WPS_ALLLED=y TCPDUMP=y BCM4352_5G=y UTF8_SSID=y LETSENCRYPT=y
