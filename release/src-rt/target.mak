...
export RT-AX82U += DNSPRIVACY=y FRS_FEEDBACK=n FORCE_AUTO_UPGRADE=n
export RT-AX82U += IFTTT=y  FRS_LIVE_UPDATE=y AHS=n NTPD=y OPENSSL11=y NANO=y UPNPIGD2=n
export RT-AX82U += TOR=y SNMPD=n NFS=y ROG=y ROG_UI=n
